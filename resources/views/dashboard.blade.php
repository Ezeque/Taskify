 ...
 @section('content')
     ...
     <div class="painel d-flex flex-column justify-content-center align-items-center">
     	<img src="images/taskify_logo.png" style="width: 200px">;
     ...
     @guest
         ...
         <li class="roboto login justify-content-between d-flex align-items-center flex-column"
         style="background-image: url(images/Login_painel.png);"><span>Already have an account?</span> <br>
         <button class="b_apresentative"><a href="/login" style="margin-top: 170px;">
         <h2>Log-in</h2>
         </a></button>
         </li>
         <li class="roboto login justify-content-between d-flex align-items-center flex-column"
         style="background-image: url(images/Signin_painel.png);"><span>Haven't signed in yet?</span> <br>
         <button class="b_apresentative"><a href="/register">
         <h2>Sign in</h2>
         </a></button>
         </li>
         <li class="roboto login justify-content-between d-flex align-items-center flex-column"
         style="background-image: url(images/waw_painel.png);"><span>Don't know Taskify yet?</span> <br>
         <button class="b_apresentative"><a href="/unfinished">
         <h2>Who Are We</h2>
         </a></button>
         </li>
         </ul>
